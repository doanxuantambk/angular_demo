...
//        config.useSingleServer().setAddress(jHipsterProperties.getCache().getRedis().getServer());
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration) {
        return cm -> {
            createCache(cm, com.app.demo.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            createCache(cm, com.app.demo.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            createCache(cm, com.app.demo.domain.User.class.getName(), jcacheConfiguration);
            createCache(cm, com.app.demo.domain.Authority.class.getName(), jcacheConfiguration);
            createCache(cm, com.app.demo.domain.User.class.getName() + ".authorities", jcacheConfiguration);
